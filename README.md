...
Node 1: You need to use your headers of your browser, for example User-agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) 

Chrome/121.0.0.0 Safari/537.36 and Accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,*/*;q=0.8  , you can get this running this command:
